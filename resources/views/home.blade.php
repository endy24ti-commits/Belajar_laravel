...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link font-custom" href="#">Features</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link font-custom" href="#">Pricing</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link font-custom" href="#">Contact</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <section class="hero-section">
        <div class="container">
            <h1 class="display-mb6 mb-2">{{ $username }}</h1>
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-text font-custom">Our application provides a clean and intuitive interface, allowing users to
                            navigate easily and perform tasks efficiently. Built with Laravel and Bootstrap, it offers
                            flexibility and responsiveness.</p>
                        <a href="#" class="btn btn-primary font-custom">Explore More</a>
                    </div>
                </div>
            </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('question.store') }}" method="POST">
                            @csrf
                            <div class="mb-3">
                                <label for="nama" class="form-label font-custom">Nama</label>
                            ...
                            <div class="mb-3">
                                <label for="pertanyaan" class="form-label font-custom">Pertanyaan</label>
                                <textarea class="form-control" rows="4" name="pertanyaan"></textarea>
                            </div>
                            <button type="submit" class="btn btn-primary font-custom">Kirim Pertanyaan</button>
                        </form>
                    </div>
                </div>
    </section>
